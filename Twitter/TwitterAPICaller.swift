...
//  Copyright © 2019 Paola Jose Lora. All rights reserved.
//
...
class TwitterAPICaller: BDBOAuth1SessionManager {
    ...
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "Idw0ZdzVwYXlyaMki358OxZCA", consumerSecret: "rKjolHEItnZQ30PNT590v9knNYAmNxOiYapbBoZzod14jUCcfP")
    var loginSuccess: (() -> ())?
    ...
    func login(url: String, success: @escaping () -> (), failure: @escaping (Error) -> ()){
        ...
        TwitterAPICaller.client?.fetchRequestToken(withPath: url, method: "GET", callbackURL: URL(string: "bdoauth://"), scope: nil, success: { (requestToken: BDBOAuth1Credential!) -> Void in
